...
class UsuarioResourceIT {
    ...
    public static Usuario createEntity(EntityManager em) {
        Usuario usuario = new Usuario().email(DEFAULT_EMAIL).nome(DEFAULT_NOME).senha(DEFAULT_SENHA);
        return usuario;
    }
    ...
    public static Usuario createUpdatedEntity(EntityManager em) {
        Usuario usuario = new Usuario().email(UPDATED_EMAIL).nome(UPDATED_NOME).senha(UPDATED_SENHA);
        return usuario;
    }
    ...
    void putNewUsuario() throws Exception {
        ...
        updatedUsuario.email(UPDATED_EMAIL).nome(UPDATED_NOME).senha(UPDATED_SENHA);
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.email(UPDATED_EMAIL).nome(UPDATED_NOME);
    ...
    void fullUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.email(UPDATED_EMAIL).nome(UPDATED_NOME).senha(UPDATED_SENHA);
