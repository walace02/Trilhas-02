...
class TrilhaResourceIT {
    ...
    void createTrilha() throws Exception {
        ...
        assertThat(testTrilha.getDataHora()).isEqualTo(DEFAULT_DATA_HORA);
    }
    ...
    void putNewTrilha() throws Exception {
        ...
        assertThat(testTrilha.getDataHora()).isEqualTo(UPDATED_DATA_HORA);
    }
    ...
    void partialUpdateTrilhaWithPatch() throws Exception {
        ...
        partialUpdatedTrilha.nomeTrilha(UPDATED_NOME_TRILHA).descricao(UPDATED_DESCRICAO).dataHora(UPDATED_DATA_HORA);
