...
class CadastroTrilhaResourceIT {
    ...
    void createCadastroTrilha() throws Exception {
        ...
        assertThat(testCadastroTrilha.getNomeTrilha()).isEqualTo(DEFAULT_NOME_TRILHA);
        assertThat(testCadastroTrilha.getNomeMunicipio()).isEqualTo(DEFAULT_NOME_MUNICIPIO);
    ...
    void checkNomeTrilhaIsRequired() throws Exception {
        ...
        // set the field null
        cadastroTrilha.setNomeTrilha(null);
    ...
    void checkNomeMunicipioIsRequired() throws Exception {
        int databaseSizeBeforeTest = cadastroTrilhaRepository.findAll().size();
        // set the field null
        cadastroTrilha.setNomeMunicipio(null);
    ...
    void putNewCadastroTrilha() throws Exception {
        ...
        CadastroTrilha testCadastroTrilha = cadastroTrilhaList.get(cadastroTrilhaList.size() - 1);
        assertThat(testCadastroTrilha.getNomeTrilha()).isEqualTo(UPDATED_NOME_TRILHA);
        assertThat(testCadastroTrilha.getNomeMunicipio()).isEqualTo(UPDATED_NOME_MUNICIPIO);
    ...
    void partialUpdateCadastroTrilhaWithPatch() throws Exception {
        ...
        partialUpdatedCadastroTrilha.descricao(UPDATED_DESCRICAO).comprimento(UPDATED_COMPRIMENTO);
