...
class CadastroTrilhaResourceIT {
    ...
    void createCadastroTrilha() throws Exception {
        ...
        assertThat(testCadastroTrilha.getAvaliacao()).isEqualTo(DEFAULT_AVALIACAO);
    ...
    void putNewCadastroTrilha() throws Exception {
        ...
        assertThat(testCadastroTrilha.getAvaliacao()).isEqualTo(UPDATED_AVALIACAO);
    ...
    void partialUpdateCadastroTrilhaWithPatch() throws Exception {
        ...
        partialUpdatedCadastroTrilha.comprimento(UPDATED_COMPRIMENTO).avaliacao(UPDATED_AVALIACAO);
