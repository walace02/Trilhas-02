...
public class Usuario implements Serializable {
    ...
    public void setTrilhas(Set<Trilha> trilhas) {
        if (this.trilhas != null) {
            this.trilhas.forEach(i -> i.setUsuario(null));
        }
        if (trilhas != null) {
    ...
    public Usuario trilhas(Set<Trilha> trilhas) {
        this.setTrilhas(trilhas);
        return this;
    }

    public Usuario addTrilha(Trilha trilha) {
        this.trilhas.add(trilha);
        trilha.setUsuario(this);
        return this;
    }

    public Usuario removeTrilha(Trilha trilha) {
