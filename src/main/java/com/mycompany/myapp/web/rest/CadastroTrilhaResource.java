    ...
    public ResponseEntity<CadastroTrilha> partialUpdateCadastroTrilha(
        ...
        Optional<CadastroTrilha> result = cadastroTrilhaRepository
            ...
            .map(existingCadastroTrilha -> {
                if (cadastroTrilha.getNomeTrilha() != null) {
                    existingCadastroTrilha.setNomeTrilha(cadastroTrilha.getNomeTrilha());
                }
                if (cadastroTrilha.getNomeMunicipio() != null) {
                    existingCadastroTrilha.setNomeMunicipio(cadastroTrilha.getNomeMunicipio());
                }
