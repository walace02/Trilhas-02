...
public class TrilhasResource {
     ...
     */
    @PostMapping("/trilhas")
    public ResponseEntity<Trilhas> createTrilhas(@RequestBody Trilhas trilhas) throws URISyntaxException {
    ...
    public ResponseEntity<Trilhas> updateTrilhas(@PathVariable(value = "id", required = false) final Long id, @RequestBody Trilhas trilhas)
